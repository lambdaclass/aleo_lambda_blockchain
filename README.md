...
```shell
cargo run --release -- program deploy aleo/hello.main
```
...
```shell
cargo run --release -- program execute aleo/hello.aleo hello 1u32 1u32 APrivateKey1zkp2cENUxETPvDcoN7dpnPX9qv1acx5U82HkgYPtE6EKsGZ
```

At the moment, this requires an aleo private key as found in an aleo project program.json or generated by the `aleo account new` command of the [cli](https://github.com/AleoHQ/aleo/) (this functionality will be ported to this project shortly).
